...
const CACHE = 'poly-reducer-v15';
const SHELL = [
  './', './index.html', './app.html', './tutorial.html',
  './styles.css', './app.js', './ads.js', './billing.js',
  './manifest.webmanifest', './icon.svg', './assets/icon-only.png',
  './vendor/assets/logo.stl',
