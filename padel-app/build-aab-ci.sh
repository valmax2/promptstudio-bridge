...
# adattiva (mipmap-anydpi-v26) usando un colore di sfondo di default -
# "icon-only.png" attiva invece la modalità "esperta", che si aspetta ANCHE
# icon-foreground.png/icon-background.png separati: senza quei due file
# genera solo l'icona piatta e salta silenziosamente quella adattiva, che è
# quella che i launcher moderni usano davvero - da qui l'icona "generica"
# vista dopo l'installazione nonostante lo step non dia alcun errore.
...
if npx capacitor-assets generate --android; then
  ...
  echo "⚠ Generazione icona saltata."
